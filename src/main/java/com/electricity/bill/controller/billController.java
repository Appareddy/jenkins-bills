...
public class billController {
	...
	@PutMapping("/bill/{id}")
	public ResponseEntity<Object> updateBill(@RequestBody bill billl) {
		log.info("entered into update method in bill controller");
		bill billldto;
		try {
			billldto = billservice.updateBill(billl);
			System.out.println(billldto);
			log.info("exited into update method in bill controller");
            return new ResponseEntity<Object>(billldto, HttpStatus.OK);
